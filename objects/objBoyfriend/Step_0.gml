if !(global.dead)
{
	...
	if (sprite_index = sprites.idle) image_index = bopFrame;
}
...
if !(global.auto)
{
	...
	// death
	if (global.hp <= 0 + global.hpMinimum) && !(global.dead) && !(global.nofail) {
		global.dead = true;
