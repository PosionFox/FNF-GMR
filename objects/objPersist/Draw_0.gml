...
if (timeUntilMoveOn < timeUntilMoveOnMax)
{
	...
	var camHeightDown = ((global.camHeight / global.camZoom) * global.downScroll);
	var camHeightNegative = global.camHeight / global.camZoom;
	if (global.downScroll) camHeightNegative = -global.camHeight;
	draw_surface_ext(global.hudSurface, camX, camY + camHeightDown, ((global.camWidth / global.camZoom) / 1280), ((camHeightNegative / global.camZoom) / 720), 0, c_white, 1);
